...
const AuthorCard = () => {
  return (
    <div className="bg-purple rounded-md md:p-4  p-2 flex items-start gap-2 md:gap-4  sm:max-w-2xl 2xl:max-w-3/5 mx-auto md:mt-10 mt-4">
  <div>
      ...
      <div>
        <p className="font-medium text-sm text-black">Adeola O. Adeleye (RDN, MSc-PH)</p>
