...
const HealthConversationCards: React.FC<CardProps> = ({ icon, title, content }) => {
  return (
    <div className="card-hover bg-white shadow-lg rounded-lg p-4 h-[320px] mr-8 py-10 md:h-[320px] border border-gray-200 w-full cursor-default">
      <div className="flex flex-col justify-center space-x-3 mb-3">
        <div className="bg-purple-100 text-purple-600 p-4 mb-4 flex justify-center items-center h-12 w-12 rounded-full transition-all duration-400 group-hover:bg-primary group-hover:text-white">
