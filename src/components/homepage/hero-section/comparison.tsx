  ...
  return (
    <section className=" py-6 text-center  md:py-10 ">
      ...
      <div className="flex w-full justify-between text-sm md:px-8">
        <div className="bg-[#F3EAFA] shadow-md px-2 pt-2 rounded w-32 md:w-48 md:pb-14">
      ...
      <div className="bg-primary shadow-md px-2 pt-2 pb-4 rounded w-32 md:w-48 md:pb-14">
