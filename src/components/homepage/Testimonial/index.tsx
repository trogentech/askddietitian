...
const Testimonial = () => {
  return (
    <section className="flex flex-col  pb-10  md:flex-row md:py-4 md:min-h-screen">
          <div className='w-full md:w-1/2 md:py-2 '>
      <h2 className="text-xl font-bold mb-2 md:px-4 md:mb-10 leading-tight text-black md:text-4xl">
  Your Path to Better
  <br className="hidden md:inline" /> Health
  <br className="block md:hidden" />
  <span className="hidden md:inline"> Starts Here</span>
</h2>

      <p className="text-sm md:text-xl text-gray-600 mb-4 md:mb-10 md:px-4">
      ...
      <div className="bg-blue-50 md:mb-10  border-l-8 border-blue md:px-8 p-4 rounded mb-4 text-sm text-gray-800">
        <p className="md:text-lg">
          ...
          Your eating plan will be backed by evidence but designed<br className="hidden md:inline" /> 
           for your real life.
        </p>
      ...
      <div className="mt-6 md:mt-0 w-full rounded-md md:w-1/2  ">
        <Image
          ...
          className="rounded md:w-full md:pb-10 md:pr-20"
        />
      </div>
    </section>
  )
