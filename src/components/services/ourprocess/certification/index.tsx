...
const OurProcesssNutritionCertfication = () => {
  return (
    <div>
            <div className="px-4 md:px-10  text-center py-10 mb-12">
        ...
        <div className="flex flex-wrap  md:w-full  gap-y-2 text-black font-medium text-sm md:text-[14px]">
          
            <div  className="flex flex-col md:w-[250px] md:flex-row md:justify-center  md:mr-4">
              <span className="text-start md:text-md      font-medium md:border-none leading-tight md:pl-0 ">
        ...
        <div  className="flex flex-col md:w-[250px]  md:text-md  md:flex-row md:justify-center">
              <span className="text-start   font-medium md:border-none leading-tight md:pl-0 ">
            FIDES (WHO)
               </span>
